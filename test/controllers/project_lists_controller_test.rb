...
class ProjectListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_list" do
    assert_difference('ProjectList.count') do
      post project_lists_url, params: { project_list: { personal_project_id: @project_list.personal_project_id, project: @project_list.project, user_id: @project_list.user_id } }
    end
  ...
  test "should update project_list" do
    patch project_list_url(@project_list), params: { project_list: { personal_project_id: @project_list.personal_project_id, project: @project_list.project, user_id: @project_list.user_id } }
